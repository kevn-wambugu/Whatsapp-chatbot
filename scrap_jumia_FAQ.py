...
"""This file scraps questions and responses from the Frequently asked questions page in Jumia.co.ke,
...
for i in range(1, 3):
    url = "https://www.jumia.co.ke/sp-how-to-pay/"
...
df.to_csv("Jumia_data_questions.csv")
