...
sw_list = {'ll', 'haven', "that'll", 'against', 'himself', 'his', 'all', 'very','favorite'
              'some', 'm', "needn't", 'only', 'aren', 'i', 'their', 'for', 'between',
              'but', "she's", "shan't", 'wouldn', 'then', 'from', 'theirs', "weren't",'product'
              'does', 'again', 'when', "you're", 'its', 'and', 'they', 'under', 'shouldn',
              'than', 'didn', 'more', 'so', 'on', 'nor', 'any', 'into', 'how', 'whom','Jumia','looking'
              'wasn', 'was', "you've", 'hasn', 'don', 'yourselves', 'y', 'doing','some'
              "doesn't", 'have', 'to', 'same', 'or', 'other', 'ain', 'did', 'mustn','give',
              ...
              'this', 'while', 'about', 'yours', 'the', 've', "it's", 'shan', 'why','credit', 'debit'
              'yourself', 'each', 'are', 'an', 'we', 'a', 'up', 'at', 'if', 's', 'until','my'
              ...
              'both', 'where', "isn't", 'those', 'themselves', 'am', 'such', 'further', 'of','?'
              'them', 'had', 'me', 'him', 'you', 'it', 'be', 'during', 'weren', 'off','buy', 'sell',
